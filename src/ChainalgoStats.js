...
function ChainalgoStats() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        // Fetch chain algorithm stats using rpcCall
        const response = await rpcCall("getchainalgostats"); // Replace with the correct RPC method
        setChainalgoStats(response);
  ...
  if (error) {
    ...
    // Calculate total and percentages for chart data
